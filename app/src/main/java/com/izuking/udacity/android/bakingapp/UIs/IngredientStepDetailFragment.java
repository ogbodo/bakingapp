...
public class IngredientStepDetailFragment extends Fragment implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    public static final String CURRENT_WINDOW_INDEX = "window_index";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPlayerView = (SimpleExoPlayerView) rootView.findViewById(R.id.step_video);
        ...
        switch (v.getId()) {
            case R.id.bt_next:
                if (mIndex < mSteps.size() - 1) {
                    ...
                    Toast.makeText(getActivity(), R.string.lastSteps, Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.bt_previous:
                if (mIndex > 0) {
                    ...
                    Toast.makeText(getActivity(), R.string.firstSteps, Toast.LENGTH_LONG).show();
                }
                break;
        }
    }
            ...
            if (cause instanceof MediaCodecRenderer.DecoderInitializationException) {
                ...
                if (decoderInitializationException.decoderName == null) {
                    if (decoderInitializationException.getCause() instanceof MediaCodecUtil.DecoderQueryException) {
                        errorString = getString(R.string.decodersQueryingError);
                    } else if (decoderInitializationException.secureDecoderRequired) {
                        errorString = getString(R.string.secureDecoderError,
                                decoderInitializationException.mimeType);
                    } else {
                        errorString = getString(R.string.decoderError,
                                decoderInitializationException.mimeType);
                    }
                } else {
                    errorString = getString(R.string.decoderInstantiationError,
