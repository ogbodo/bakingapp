        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_favorite:
                if (isFavorite()) {
                    ...
                    Toast.makeText(this, String.format(getString(R.string.favoriteRemoved), mRecipe.getName()), Toast.LENGTH_LONG).show();
                } else {
                    addRecipeToFavorites();
                    item.setIcon(R.drawable.ic_favorite_added);
                    Toast.makeText(this, String.format(getString(R.string.favoriteAdded), mRecipe.getName()), Toast.LENGTH_LONG).show();
                }
                return true;
            default:
